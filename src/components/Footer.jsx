    ...
    >
      <div className={` ${layout.sectionInfo}`}>
        ...
        <div className="grid grid-cols-2">
          ...
          <a href="https://github.com/IfrahQureshi" target="_blank" rel="noreferrer">
            <Button
      ...
      <div className="md:ml-auto mt-10 md:mt-0 flex items-center justify-center">
        <div className="w-[200px] h-[200px] border-2 border-teal-200 relative z-[5] rounded-full bg-gradient-to-br from-teal-500 to-blue-600 flex items-center justify-center">
          <span className="text-white font-poppins font-bold text-[56px]">
